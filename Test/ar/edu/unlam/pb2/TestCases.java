...
public class TestCases {
	...
	public void queUnAlumnoDePrimariaPuedaAsistir() throws SinCursosDisponiblesException, NoEstaHabilitadoException, DocenteNoTieneCompetencia {
		...
		Curso cuartoGrado = new GradoPrimaria(DESCRIPCION_DEL_CURSO, CL, EDAD, Grado.CUARTO);
	...
	public void queSiNoHayUnCursoSeArrojeLaExcepcionSinCursosDisponiblesException() throws SinCursosDisponiblesException, NoEstaHabilitadoException {
		...
		Curso tercerGrado = new GradoPrimaria(DESCRIPCION_DEL_CURSO, CL, EDAD, Grado.TERCERO);
	...
	public void queUnAlumnoDeSecundariaPuedaAsistir() throws SinCursosDisponiblesException, NoEstaHabilitadoException {
		...
		Curso cuartoAnio = new CursoSecundaria(DESCRIPCION_DEL_CURSO, CL, EDAD, Anio.CUARTO);
	...
	public void queUnAlumnoDePrimariaPuedaRendirUnaPrueba() throws SinCursosDisponiblesException, NoEstaHabilitadoException {
		...
		cuartoGrado.setDocente(lorusso);				
